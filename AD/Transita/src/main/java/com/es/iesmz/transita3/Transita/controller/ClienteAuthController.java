...
public class ClienteAuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody ClienteSignupRequest signUpRequestCliente) {
    ...
    if (clientRepository.existsByEmail(signUpRequestCliente.getEmail())) {
      return ResponseEntity
          .badRequest()
    ...
    Cliente cliente = new Cliente(signUpRequestCliente.getNombreUsuario(),
               signUpRequestCliente.getEmail(),
